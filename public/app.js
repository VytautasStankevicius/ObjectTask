...
var product1 = new _class_Product__WEBPACK_IMPORTED_MODULE_0__.Product('Kamuolys', '20eu', '2023');
...
var Product = /*#__PURE__*/function () {
  ...
  _createClass(Product, [{
    key: "getProductProfile",
    value: function getProductProfile() {
      return [this.name, this.price, this.year];
    }
  }, {
    key: "addProductInfo",
    value: function addProductInfo(productData) {
      var infoDisplay = document.querySelector('.infoHolder');
      var listHolder = document.createElement('ul');
      var _iterator = _createForOfIteratorHelper(productData),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var data = _step.value;
          var dataHolder = document.createElement('li');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjs_object_workstation"] = self["webpackChunkjs_object_workstation"] || [];
